...
/**
 * Set up the run
 * @param {org.acme.mynetwork.CreatePlan} createPlan - the setUp transaction instance
...
/**
 * Set up the run
 * @param {org.acme.mynetwork.CreateGroup} createGroup - create a group and divisions
 * @return {Promise} Asset Registry Promise
 * @transaction
 */
...
/**
 * Set up the run
 * @param {org.acme.mynetwork.CreateBillingProvider} createBillingProvider - the setUp transaction instance
 * @return {Promise} Asset Registry Promise
 * @transaction
 */
...
/**
 * Set up the run
 * @param {org.acme.mynetwork.CreateSubscriber} createSubscriber - the setUp transaction instance
 * @return {Promise} Asset Registry Promise
 * @transaction
 */
...
/**
 * Set up the run
 * @param {org.acme.mynetwork.CreateSubmittedClaim} createSubmittedClaim - the setUp transaction instance
 * @return {Promise} Asset Registry Promise
 * @transaction
 */
...
/**
 * Adjudicate a claim
 * @param {org.acme.mynetwork.AdjudicateDentalClaim} adjudicateDentalClaim - the adjudicateDentalClaim transaction instance
 * @return {Promise} Asset Registry Promise
 * @transaction
 */
...
/**
 * Pay a claim
 * @param {org.acme.mynetwork.PayDentalClaim} payDentalClaim - pay the adjudicated claim
 * @return {Promise} Asset Registry Promise
 * @transaction
 */
 ...
 * @param {org.acme.mynetwork.PostTransaction} postTransaction - the transaction to be processed
 * @transaction
 ...
 * @param {org.acme.mynetwork.AddEnrollees} addEnrollees - the transaction to be processed
 * @transaction
 * @return {Promise} a promise that resolves when transaction processing is complete
 */
